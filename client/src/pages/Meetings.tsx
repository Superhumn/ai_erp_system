...
export default function Meetings() {
  ...
  const { data: taskRoutingData } = trpc.fireflies.taskRoutingOptions.useQuery();
  const availableProjects: Array<{ id: number; name: string }> = (taskRoutingData as any)?.projects || [];
                      ...
                      {meeting.processingStatus === "pending" && (
                        <Button
                          ...
                          onClick={() => {
                            setSelectedMeetingId(meeting.id);
                            setProcessProjectName("");
                            setProcessCreateContacts(true);
                            setProcessCreateTasks(true);
                            ...
                            if (predicted !== undefined) {
                              ...
                              setPredictedProjectId(undefined);
                            }
                            setShowProcessDialog(true);
                          }}
                        >

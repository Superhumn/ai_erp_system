-- STEP 2 (08) — procurement: stamp entity ownership + backfill to US + index.
--
...
-- ============================== UP ==============================
-- vendorRfqs
UPDATE vendorRfqs SET companyId = (SELECT id FROM companies WHERE code = 'US') WHERE companyId IS NULL;
CREATE INDEX idx_vendorRfqs_companyId ON vendorRfqs (companyId);

-- ============================== DOWN ==============================
-- Intentionally commented out so applying this file can't drop anything. Uncomment to roll back.
-- DROP INDEX idx_vendorRfqs_companyId ON vendorRfqs;

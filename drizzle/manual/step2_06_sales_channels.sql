-- STEP 2 (06) — sales_channels: stamp entity ownership + backfill to US + index.
--
...
-- ============================== UP ==============================
-- shopifyStores
UPDATE shopifyStores SET companyId = (SELECT id FROM companies WHERE code = 'US') WHERE companyId IS NULL;
CREATE INDEX idx_shopifyStores_companyId ON shopifyStores (companyId);

-- ============================== DOWN ==============================
-- Intentionally commented out so applying this file can't drop anything. Uncomment to roll back.
-- DROP INDEX idx_shopifyStores_companyId ON shopifyStores;
